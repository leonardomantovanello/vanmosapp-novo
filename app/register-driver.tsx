...
export default function RegisterDriver() {
  ...
  function handleSignUp() {
    if (!name.trim() || !email.trim() || !password.trim() || !cnh.trim()) {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} placeholder="Driver's license (CNH)" placeholderTextColor="#888" value={cnh} onChangeText={setCnh} />
